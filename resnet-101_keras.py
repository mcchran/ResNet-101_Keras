...
import sys
# set max depth of Python interpreter stack; prevent infinite recursion from causing overflow of the C stack
...
from utils.load_cifar10 import load_cifar10_data
...
def resnet101_model(img_rows, img_cols, color_type=1, num_classes=None):
    ...
    if K.image_dim_ordering() == 'th':
        ...
        weights_path = '/home/davros/Datasets/ResNet_101/resnet101_weights_tf.h5'
